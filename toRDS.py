...
def sendToRDS():
    ...
    for file in files:
        try:
            ...
            pass
    query = "insert into Meet_covid values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s);"
