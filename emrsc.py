...
def runemr():
    ...
    Steps=[
        ...
        },
        {
            ...
            'HadoopJarStep': {
                'Jar': 'command-runner.jar',
                'Args': ['spark-submit','--jars','/usr/share/java/mysql-connector-java-8.0.29.jar,/usr/share/java/aws-java-sdk-bundle-1.11.271.jar,/usr/share/java/hadoop-aws-2.10.1.jar',config.get('script2')[0]]
            }
        }
        ],
